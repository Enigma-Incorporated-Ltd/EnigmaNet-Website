...
const MatricCardSlider: React.FC<CardSliderProps> = ({
  data,
  cardShow = 3,
  title,
  description,
            ...
            >
              {data.map(feature => (
                <SwiperSlide key={feature.id} className="h-auto py-3">
                  <Card className="proof-card h-100 mx-2">
                    <div className="gold-divider"></div>

                    <div className={`proof-label ${!feature.metric && 'fs-4' }`}>
                      {feature.title.toUpperCase()}
                    </div>
                    {feature.metric && <div className="proof-metric">{feature.metric}</div>}

                    <p className="proof-description mb-0">{feature.description}</p>
                  </Card>
                </SwiperSlide>
              ))}
            </Swiper>
...
export default MatricCardSlider;