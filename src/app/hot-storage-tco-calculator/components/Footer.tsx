...
const footerData: FooterData = {
  ...
  links: [
    ...
    { title: 'TCO Calculator', url: '/tco-calculator' },
    { title: 'About Us', url: '/about-v1' },
    { title: 'Contact', url: '/contacts-v1' },
  ],
  policies: [
  ...
  copyright: {
    text: 'All rights reserved. Enigma Secure Cloud',
    by: '',
    url: '#',
  },
};
...
const Footer = () => {
  ...
  return (
    <footer className="footer bg-secondary pt-5 pb-4 pb-lg-5 mt-5">
