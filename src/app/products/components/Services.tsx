...
const Services = () => {
  return (
    <section className="bg-body pb-md-2 pb-lg-5">
      <div className="d-none d-lg-block" style={{ marginTop: '-60px', paddingTop: '60px' }}></div>

      <Container className="pb-4 pt-5">
        {/* <h2 className="h1 text-center text-md-start mb-lg-4 pt-1 pt-md-4">Our Products</h2> */}
        <HeaderTitle
          className="h1 text-center mb-lg-4 pt-1 pt-md-4"
          title="Our Products"
        />
