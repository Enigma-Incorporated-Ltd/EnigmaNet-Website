import '../RecentActivity/recent-activity.css'; // Reuses activity styling, card layout, and badges

interface HealthSummaryViewProps {
  setActiveNav: (nav: string) => void;
}

export default function HealthSummaryView({ setActiveNav }: HealthSummaryViewProps) {
  return (
