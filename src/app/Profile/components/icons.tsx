/* Shared SVG icon helpers used across profile components */
export const Icon = {
  User: () => (
...
export const SuccessScreen = ({ title, desc }: { title: string; desc: string }) => (
  <div className="success-screen">
    ...
    <h3 className="success-screen__title">{title}</h3>
    <p className="success-screen__desc">{desc}</p>
  </div>
);
